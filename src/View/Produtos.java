...
public class Produtos extends JDialog {
	...
	public Produtos() {
		...
		txtCusto.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				// valida��o (somente n�meros ao digitar)
	...
	/**
	 * M�todo respons�vel por pesquisar um produto na tabela;
	 */
	...
	/**
	 * M�todo respons�vel por pesquisar um fornecedor na tabela;
	 */
	...
	/**
	 * M�todo respons�vel de pesquisar produto pelo ID
	 */
		...
		/**
		 * M�todo resons�vel por pesquisar produto por c�digo de barras
		 */
		...
		/**
		 * M�todo respons�vel por criar um produto no banco
		 */
		...
		private void adicionarProduto() {	
			if (txtProduto.getText().isEmpty()) {
				...
				JOptionPane.showMessageDialog(null, "Informe a descri��o do produto");
				...
				JOptionPane.showMessageDialog(null, "Informe o estoque m�nimo do produto");
				...
				try {				
					...
					JOptionPane.showMessageDialog(null, "BarCode j� exixtente.\nDigite outro");
		...
		private void alterarProduto() {		
			if (txtProduto.getText().isEmpty()) {
				...
				try {		
					...
					JOptionPane.showMessageDialog(null, "BarCode j� existente.\nDigite outro");
					txtBarCode.setText(null);
					txtBarCode.requestFocus();
				} catch (Exception e) {
					System.out.println(e);
		...
		/**
		 * M�todo respons�vel para excluir um produto
		 */
		...
		/**
		 * M�todo respons�vel por limpar os campos da tela produtos barcode
		 */
